...
beautypop.directive('adsFactor', function($window, $compile) {
    return {
        restrict: 'A',
        template: '',
        link: 
 ...
 * </ul>
 */
beautypop.filter('objFilter', function() {
 ...
 * trustAsHtml
 */
beautypop.filter('to_trusted', ['$sce', function($sce){
 ...
 */
beautypop.directive('ngConfirmClick', [function() {
    return {
        restrict: 'A',
 ...
 */
beautypop.directive('validFile',function(){
    return {
        require:'ngModel',
