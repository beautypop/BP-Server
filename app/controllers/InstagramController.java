...
public class InstagramController extends Controller{
	private static play.api.Logger logger = play.api.Logger.apply(InstagramController.class);
	...
	public static Result newProduct() {
	    ...
	    String images = HttpUtil.getMultipartFormDataString(multipartFormData, "images");
	...
	private static Result newProduct(
		...
		try {
			...
			//for (String image : images) {
				//String fileName = image.getFilename();
				File fileTo =  ImageFileUtil.copyImageFileFromUrl("temp.jpg", images);
				newPost.addPostPhoto(fileTo);
			//}
